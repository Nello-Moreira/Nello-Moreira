...
I turn ML models into production APIs that scale.

**Recent work:**
- 🚀 Deployed scikit-learn models (70% precision) that increased revenue 5%
- ⚡ Reduced API p95 latency 75% via load testing & optimization
- 💰 Cut AWS costs 50% with Docker + microservices

**Stack:** Node.js, TypeScript, Python, PostgreSQL, Redis, Docker, AWS (EC2/RDS/S3), BullMQ, GitHub Actions

My toolkit also includes Machine Learning, Bash, Linux, Git, GitHub Actions, Business Intelligence (BI), and Code reviews, among other technologies, making me adaptable and resourceful in diverse development environments. I’m passionate about solving complex problems and continuously evolving my skill set to stay ahead in the rapidly changing tech landscape.
